                      ...
                      <div className="space-y-4">
                        {reservations.slice(0, 5).map((reservation) => (
                          ...
                          >
                            ...
                            <span className={`px-3 py-1 rounded-full text-xs font-medium ${reservation.status === 'confirmed'
                        ...
                        >
                          <div className="p-6">
                            <div className="flex items-start justify-between mb-4">
                              ...
                              <span className={`px-4 py-2 rounded-lg text-sm font-medium ${reservation.status === 'confirmed'
                                ? 'bg-success-100 text-success-700'
                                : reservation.status === 'pending'
                                  ? 'bg-warning-100 text-warning-700'
                                  : 'bg-danger-100 text-danger-700'
                            ...
                            <div className="pt-4 border-t border-secondary-200">
                              <p className="text-sm text-secondary-600">
                                Guests: {reservation.numberOfGuests || 1} • Booked on{' '}
